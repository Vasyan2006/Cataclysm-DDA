                            ...
                            std::string &action )
{
    ...
    mvwprintz( w_stats, point( 0, 9 ), c_light_gray, "%26s", "" );
    ...
    if( !you.male ) {
        mvwprintz( w_stats, point( 1, 7 ), c_light_gray, _( "Breast:" ) );
    }
    wrefresh( w_stats );
}
                                  ...
                                  const size_t skill_win_size_y )
{
    ...
    mvwprintz( w_stats, point( 19, 6 ), c_white,  "%.3f", weight );
    ...
    if( !you.male ){
        ...
        mvwprintz( w_stats, point( 1, 7 ), c_light_gray, _( "Breast:" ) );
        mvwprintz( w_stats, point( 19, 7 ), c_white, b00bs_size );
    }
